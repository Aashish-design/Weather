...
const main = document.querySelector(".allbck");
var date = new Date();
...
async function startweather(city) {
  ...
  if (data.weather[0].main == "Clouds") {
    ...
    main.style.background = "url(images/cloud1.jpg)";
    ...
    back.style.backgroundSize = "cover";
    main.style.background = "url(images/rain-bg.jpg)";
    main.style.backgroundSize = "cover";
    icon.src = "images/rain.svg";
  } else if (data.weather[0].main == "Clear") {
    back.style.background = "url(images/winter-mist.jpg)";
    back.style.backgroundSize = "cover";
    main.style.background = "url(images/winter-mist.jpg)";
    main.style.backgroundSize = "cover";
    icon.src = "images/clear.svg";
  } else if (data.weather[0].main == "Haze") {
    back.style.background = "url(images/mist-bg.jpg)";
    back.style.backgroundSize = "cover";
    main.style.background = "url(images/mist-bg.jpg)";
    main.style.backgroundSize = "cover";
    icon.src = "images/mist.svg";
  } else if (data.weather[0].main == "Sunny") {
    back.style.background = "url(images/sunny-bg.jpg)";
    back.style.backgroundSize = "cover";
    main.style.background = "url(images/sunny-bg.jpg)";
    main.style.backgroundSize = "cover";
...
async function checkweather(city) {
  ...
  if (output.status == 404) {
    ...
    if (data.weather[0].main == "Clouds") {
      ...
      back.style.backgroundSize = "cover";
      main.style.background = "url(images/clear-bg.jpg)";
      main.style.backgroundSize = "cover";
      icon.src = "images/clear.svg";
    } else if (data.weather[0].main == "Haze") {
      back.style.background = "url(images/mist-bg.jpg)";
